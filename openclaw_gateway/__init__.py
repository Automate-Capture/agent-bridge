...
- ConversationContextManager: Context management with LRU eviction and WAL
- DeduplicationTracker: Duplicate message detection and WAL persistence
- ProtocolNegotiationManager: Protocol capability matrix and selection
- StateCoordinator: State coordination with vector clocks and LWW
- SemanticContextPreserver: Semantic intent validation and preservation
...
try:
    ...
    DeduplicationTracker = None  # type: ignore
...
try:
    ...
    ProtocolNegotiationManager = None  # type: ignore

try:
    from openclaw_gateway.state_coordinator import StateCoordinator
except ImportError:
    StateCoordinator = None  # type: ignore

try:
    from openclaw_gateway.semantic_preserver import SemanticContextPreserver
except ImportError:
    SemanticContextPreserver = None  # type: ignore
