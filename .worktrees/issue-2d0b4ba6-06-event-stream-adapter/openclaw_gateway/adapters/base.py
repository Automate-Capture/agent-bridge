...
This module defines the interface contract that all protocol adapters must implement
for translating between agent-specific message formats and the canonical message format.
"""
